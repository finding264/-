...
class Res_CNN1(nn.Module):
    def __init__(self):
        super(Res_CNN1, self).__init__()
        ...
        self.Conv2_0 = Conv_1(chs_in=1, chs_out=16)
        ...
        self.Conv4_0 = Conv_1(chs_in=16, chs_out=32)
        ...
        self.Conv6_0 = Conv_1(chs_in=32, chs_out=64)
        ...
        self.Conv8_0 = Conv_1(chs_in=64, chs_out=128)
        ...
        self.Conv10 = Conv_1(chs_in=512, chs_out=256)
        self.Conv10_0 = Conv_1(chs_in=128, chs_out=256)

        self.Conv11 = Conv_3(dilation=1, padding=1, chs_in=256, chs_out=256)
        self.Conv12 = Conv_3(dilation=1, padding=1, chs_in=256, chs_out=256)

        self.FC1 = nn.Linear(256 * 3, 256)
        self.FC2 = nn.Linear(256, 64)
        self.FC3 = nn.Linear(64, 4)
        self.spatial_dropout = nn.Dropout2d(p=0)
